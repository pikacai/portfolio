      ...
      <div className="caseStudySection">
        <Fade children={
          <>
              ...
              description={
                "This case study examines common complaints of on road usage for Google Maps. I investigate how Apple Maps, Waze, and others use featuresthat can be improved for Google Maps."
              }
              css={{
                background:
                  "linear-gradient(360deg, #E1EDFD 4.11%, #FAFAFA 52.25%)",
                color: "black",
              }}
              link={"google"}
            />
            ...
            <Card
              ...
              description={
                "Connecting the wealth of Haitian culture, history, and spirit with the Chicago community and beyond."
              }
              css={{
                background: "#F2F2F2",
                color: "#3C4257",
            ...
            <Card
              ...
              css={{
                background:
                  "conic-gradient(from 153.62deg at 24.2% 0%, #0070B7 0deg, #007DC2 360deg)",
                color: "white",
              }}
              link={"metlife"}
            />
            ...
            <Card
              ...
              description={
                "I examine how to increase the rate of purchasing on Amazon grocery."
              }
              css={{
