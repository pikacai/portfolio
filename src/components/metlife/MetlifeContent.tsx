...
const MetlifeContent = () => {
    const outcomes = [
        ...
        'Incorporates communities to build professional networks.',
        ...
        <div>
            ...
            <div className='min-h-screen w-screen flex flex-wrap justify-center items-center bg-black gap-12 pl-8 pr-8 pt-48 pb-48'>
                    <div className='flex flex-col flex-1 bg-[#151517] p-10 rounded-md'>
                        ...
                        <div className='pt-20 pb-20'>
                            ...
                            <h1 className='text-5xl text-center font-medium text-transparent bg-clip-text bg-gradient-to-r from-[#56CCF2] to-[#2F80ED]'>Usability Testings</h1>
                        </div>
                    </div>
            ...
            <div className='min-h-screen w-screen flex flex-col justify-center items-center'>
                <div className='w-1/2 flex flex-col gap-y-4'>
                    ...
                    <h2 className='text-3xl md:text-6xl font-semibold'>MetLife's 2022 Onboarding Survey revealed that <span className='underline'>88%</span> of employees believe their onboarding experiences could have been much better.</h2>
                </div>
            </div>
            ...
            <div className='min-h-screen w-screen flex flex-col justify-center items-center'>
                <div className='w-1/2 flex flex-col gap-y-4'>
                    <h1 className='text-xl'>Problem</h1>
                    <h2 className='text-3xl md:text-6xl font-semibold'>Despite MetLife's various networking platforms like Yammer, Teams, and Outlook, <span className='underline'>new hires may not know where to begin networking</span>. There are <span className='underline'>no</span> networking forums provided within the company.</h2>
                </div>
            </div>
            ...
            <div className='min-h-screen w-screen flex flex-col justify-center items-center bg-[#0487ce]'>
                <div className='w-1/2 flex flex-col gap-y-4'>
                    ...
                    <h2 className='text-3xl md:text-6xl text-white font-semibold'>Consolidate all social apps into one to improve onboarding experiences and to <span className='underline'>minimizing administration</span> while also increasing appeal to new hires.</h2>
                </div>
            </div>
